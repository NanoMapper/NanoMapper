...
namespace NanoMapper {
    ...
    public static class MapperExtension {
        ...
        public static void CopyTo<TSource, TTarget>(this TSource source, TTarget target, Action<Mapping<TSource, TTarget>> configure) {
        ...
        public static void CopyTo<TSource, TTarget>(this TSource source, TTarget target, Func<Mapper> mapperFactory)
            => CopyTo(source, target, mapperFactory());
        
        public static void CopyTo<TSource, TTarget>(this TSource source, TTarget target, Mapper mapper) {

        }

        public static void CopyTo<TSource, TTarget>(this TSource source, TTarget target, Mapper mapper, Action<Mapping<TSource, TTarget>> configure) {
